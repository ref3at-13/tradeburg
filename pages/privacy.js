      ...
      <main className="max-w-4xl mx-auto p-8 space-y-4">
        ...
        <ul className="list-disc list-outside pl-10 space-y-2">
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to
            Tradeburg GmbH, Nassauerring 265, 47803 Krefeld.</li>
        ...
        <p>
          ...
          You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on{' '} 
            <a
        ...
        <h3 className="text-xl font-semibold mt-8">Disclosure of Your Personal Data</h3>
          <h4 className="text-lg font-semibold mt-2">Business Transactions</h4>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
          <h4 className="text-lg font-semibold mt-2">Law enforcement</h4>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
          <h4 className="text-lg font-semibold mt-2">Other legal requirements</h4>
        ...
        <p>If you have any questions about this Privacy Policy, You can contact us at info@tradeburg.de.</p>
      </main>
