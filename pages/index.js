  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-center py-20">
        <div className="max-w-7xl mx-auto px-12">
          ...
          <div className="mt-6 md:text-center text-left">
            <a href="#contact" className="inline-block px-12 py-3 bg-white text-blue-700 rounded hover:bg-gray-100">Get Started Today</a>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-20 px-12 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-6 md:items-start">
